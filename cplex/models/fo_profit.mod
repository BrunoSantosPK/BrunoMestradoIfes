...
execute {
  ...
  var vc_file = new IloOplOutputFile("../csv/vc_l03.csv");
  vc_file.writeln("i,j,vc_value");
  
  var ec_file = new IloOplOutputFile("../csv/ec_l03.csv");
  ec_file.writeln("i,j,ec_value");
  
  var pc_file = new IloOplOutputFile("../csv/pc_l03.csv");
  pc_file.writeln("i,j,pc_value");
  
  var ca_file = new IloOplOutputFile("../csv/ca_l03.csv");
  ca_file.writeln("i,k,ca_value");
  
  var va_file = new IloOplOutputFile("../csv/va_l03.csv");
  va_file.writeln("i,k,va_value");
  
  var aa_file = new IloOplOutputFile("../csv/aa_l03.csv");
  aa_file.writeln("i,k,aa_value");
  
  var ra_file = new IloOplOutputFile("../csv/ra_l03.csv");
  ra_file.writeln("i,k,ra_value");
  
  var vp_file = new IloOplOutputFile("../csv/vp_l03.csv");
  vp_file.writeln("i,k,vp_value");
  
  var ap_file = new IloOplOutputFile("../csv/ap_l03.csv");
  ap_file.writeln("i,k,ap_value");
  
  var rc_file = new IloOplOutputFile("../csv/rc_l03.csv");
  rc_file.writeln("i,j,k,rc_value");
  
  var lc_file = new IloOplOutputFile("../csv/lc_l03.csv");
  lc_file.writeln("l,i,j,lc_value");
  
  var la_file = new IloOplOutputFile("../csv/la_l03.csv");
