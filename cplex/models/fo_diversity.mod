...
execute {
  ...
  var vc_file = new IloOplOutputFile("../csv/vc_d11.csv");
  vc_file.writeln("i,j,vc_value");
  
  var ec_file = new IloOplOutputFile("../csv/ec_d11.csv");
  ec_file.writeln("i,j,ec_value");
  
  var pc_file = new IloOplOutputFile("../csv/pc_d11.csv");
  pc_file.writeln("i,j,pc_value");
  
  var ca_file = new IloOplOutputFile("../csv/ca_d11.csv");
  ca_file.writeln("i,k,ca_value");
  
  var va_file = new IloOplOutputFile("../csv/va_d11.csv");
  va_file.writeln("i,k,va_value");
  
  var aa_file = new IloOplOutputFile("../csv/aa_d11.csv");
  aa_file.writeln("i,k,aa_value");
  
  var ra_file = new IloOplOutputFile("../csv/ra_d11.csv");
  ra_file.writeln("i,k,ra_value");
  
  var vp_file = new IloOplOutputFile("../csv/vp_d11.csv");
  vp_file.writeln("i,k,vp_value");
  
  var ap_file = new IloOplOutputFile("../csv/ap_d11.csv");
  ap_file.writeln("i,k,ap_value");
  
  var rc_file = new IloOplOutputFile("../csv/rc_d11.csv");
  rc_file.writeln("i,j,k,rc_value");
  
  var lc_file = new IloOplOutputFile("../csv/lc_d11.csv");
  lc_file.writeln("l,i,j,lc_value");
  
  var la_file = new IloOplOutputFile("../csv/la_d11.csv");
